...
void VulkanRenderer::createVertexBuffer()
{
	...
	if (vkCreateBuffer(device, &bufferInfo, allocator, &vertexBuffer) != VK_SUCCESS)
	{
	...
	if (vkAllocateMemory(device, &memoryAllocateInfo, allocator, &vertexBufferMemory) != VK_SUCCESS)
	{
